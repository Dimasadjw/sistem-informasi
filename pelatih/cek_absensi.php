...
$query = "SELECT * FROM absensi a join tb_user b on a.id_user= b.id_user join tb_ekstra c on a.id_ekstra = c.id ";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                <h3 class="mb-4 ml-5 text-gray-800">Cek Absensi</h3>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="dataTable" width="100%" cellspacing="0" style="background-color: #024040; color:white">
                                ...
                                <?php
                                // Lakukan perulangan untuk setiap baris data hasil query
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_cekabsensi.php?id=<?php echo $row['id_absensi']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="color:black">Apakah anda ingin keluar?</h5>
